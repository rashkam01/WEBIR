# -*- coding: utf-8 -*-
"""
Created on Fri Jan  5 17:13:44 2018
...
df1 = pd.read_csv("C:/Users/Rashmi/Desktop/Web IR and DM/NIPS papers _dataset/papers.csv")
#Cleaning the data
texts = []
...
for i in df1['paper_text']:
   ...
   # if type(i) is str:
    ...
    stopped_tokens = [i for i in tokens if (not i in stoplist and not str(i).isdigit() and len(str(i)) > 2 )]
...
ldamodel.save('C:/Users/Rashmi/Documents/lda_model/model.atmodel')
#Load model
#model = gensim.models.ldamodel.LdaModel.load('C:\\model.atmodel')
model = gensim.models.ldamodel.LdaModel.load('C:/Users/Rashmi/Documents/lda_model/model.atmodel')
...
f1 = open("C:/Users/Rashmi/Documents/lda_model/paper_20topicWords_new1.csv","w")
